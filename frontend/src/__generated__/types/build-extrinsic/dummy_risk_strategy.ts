...
export default class Methods {
	...
	*/
	"setResult" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "setResult", [result], __options);
	}
	...
	*/
	"setCollateralAmount" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "setCollateralAmount", [collateralAmount], __options);
	}
