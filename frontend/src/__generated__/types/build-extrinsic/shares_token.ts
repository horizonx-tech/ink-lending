...
export default class Methods {
	...
	*/
	"asset" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "asset", [], __options);
	}
	...
	*/
	"totalShare" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "psp22Shareable::totalShare", [], __options);
	}
	...
	*/
	"shareOf" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "psp22Shareable::shareOf", [owner], __options);
	}
