...
export default class Methods {
	...
	*/
	"asset" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "asset", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "shares_token");
		}, [], __options);
	}
	...
	*/
	"totalShare" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "psp22Shareable::totalShare", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "shares_token");
		}, [], __options);
	}
	...
	*/
	"shareOf" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "psp22Shareable::shareOf", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "shares_token");
		}, [owner], __options);
	}
