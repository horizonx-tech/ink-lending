import type * as EventTypes from '../event-types/shares_token';
...
export default class EventsClass {
	...
	public subscribeOnTransferEvent(callback : (event : EventTypes.Transfer) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('Transfer', 'shares_token')) as EventTypes.Transfer);
		};
	...
	public subscribeOnApprovalEvent(callback : (event : EventTypes.Approval) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('Approval', 'shares_token')) as EventTypes.Approval);
		};
	...
	public subscribeOnOwnershipTransferredEvent(callback : (event : EventTypes.OwnershipTransferred) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('OwnershipTransferred', 'shares_token')) as EventTypes.OwnershipTransferred);
		};
