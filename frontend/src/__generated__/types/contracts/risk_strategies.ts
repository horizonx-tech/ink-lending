...
import ABI from '../../artifacts/risk_strategies.json';
import QueryMethods from '../query/risk_strategies';
import BuildExtrinsicMethods from '../build-extrinsic/risk_strategies';
import TxSignAndSendMethods from '../tx-sign-and-send/risk_strategies';
import MixedMethods from '../mixed-methods/risk_strategies';
import EventsClass from '../events/risk_strategies';
