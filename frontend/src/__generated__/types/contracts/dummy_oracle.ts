...
import ABI from '../../artifacts/dummy_oracle.json';
import QueryMethods from '../query/dummy_oracle';
import BuildExtrinsicMethods from '../build-extrinsic/dummy_oracle';
import TxSignAndSendMethods from '../tx-sign-and-send/dummy_oracle';
import MixedMethods from '../mixed-methods/dummy_oracle';
import EventsClass from '../events/dummy_oracle';
