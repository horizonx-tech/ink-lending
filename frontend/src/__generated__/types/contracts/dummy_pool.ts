...
import ABI from '../../artifacts/dummy_pool.json';
import QueryMethods from '../query/dummy_pool';
import BuildExtrinsicMethods from '../build-extrinsic/dummy_pool';
import TxSignAndSendMethods from '../tx-sign-and-send/dummy_pool';
import MixedMethods from '../mixed-methods/dummy_pool';
import EventsClass from '../events/dummy_pool';
