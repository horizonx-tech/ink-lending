...
import ABI from '../../artifacts/shares_token.json';
import QueryMethods from '../query/shares_token';
import BuildExtrinsicMethods from '../build-extrinsic/shares_token';
import TxSignAndSendMethods from '../tx-sign-and-send/shares_token';
import MixedMethods from '../mixed-methods/shares_token';
import EventsClass from '../events/shares_token';
