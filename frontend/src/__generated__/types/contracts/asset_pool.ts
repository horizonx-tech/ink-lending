...
import ABI from '../../artifacts/asset_pool.json';
import QueryMethods from '../query/asset_pool';
import BuildExtrinsicMethods from '../build-extrinsic/asset_pool';
import TxSignAndSendMethods from '../tx-sign-and-send/asset_pool';
import MixedMethods from '../mixed-methods/asset_pool';
import EventsClass from '../events/asset_pool';
