...
import ABI from '../../artifacts/rate_strategies.json';
import QueryMethods from '../query/rate_strategies';
import BuildExtrinsicMethods from '../build-extrinsic/rate_strategies';
import TxSignAndSendMethods from '../tx-sign-and-send/rate_strategies';
import MixedMethods from '../mixed-methods/rate_strategies';
import EventsClass from '../events/rate_strategies';
