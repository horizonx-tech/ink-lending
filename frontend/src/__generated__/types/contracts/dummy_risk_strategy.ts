...
import ABI from '../../artifacts/dummy_risk_strategy.json';
import QueryMethods from '../query/dummy_risk_strategy';
import BuildExtrinsicMethods from '../build-extrinsic/dummy_risk_strategy';
import TxSignAndSendMethods from '../tx-sign-and-send/dummy_risk_strategy';
import MixedMethods from '../mixed-methods/dummy_risk_strategy';
import EventsClass from '../events/dummy_risk_strategy';
